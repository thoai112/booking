...
public class Room implements Serializable{
    ...
    public Room(String id, String name, String price, String about, String hoteltype_id, String hotel_id, String roomtype_id, ArrayList<String> image, String status) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.about = about;
